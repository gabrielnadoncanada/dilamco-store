...
export function ProductBreadcrumb({ product }: { product: Product }) {
  return (
    <div className="flex flex-wrap py-4 pb-8 font-mono text-[11px] tracking-[0.04em] text-muted-foreground [&_a:hover]:text-primary [&_span]:text-foreground max-[700px]:text-[11px]">
